			...
			<div class="post">
				<div class="single-content">
					...
					<div class="single-content__img" data-aos="fade-up" data-aos-offset="100">
						<div class="icon">
							<img src="<?php echo get_template_directory_uri() ?>/images/Circle_Brand.png" alt="">
						</div>
						<img class="poster" src="<?php the_field('imgBlog'); ?>" alt="">
						<p>
							<svg width="12" height="25" viewBox="0 0 12 25" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M0 24.2423C6.64983 24.1134 12.0005 18.7359 12.0005 12.1211C12.0005 5.50634 6.64983 0.128874 0 0L0 24.2423Z" fill="black" />
							</svg><strong>Palabras de:</strong> <?php the_field('author') ?>
						</p>
					</div>
