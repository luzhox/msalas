...
!(function (u) {
  ...
  var e = function (u) {
    ...
    if (
      ...
      !u.CORE_VERSION || !i.compareVersions(e.REQUIRE_CORE_VERSION, u.CORE_VERSION))
    )
      throw new Error('[MixItUp Multifilter] MixItUp Multifilter v' + e.EXTENSION_VERSION + ' requires at least MixItUp v' + e.REQUIRE_CORE_VERSION)
        ...
        handleClick: function (u) {
          ...
          l &&
            (((o = e.mixer.config.selectors.control) && !l.matches(o)) ||
              ...
              ('function' == typeof t.config.callbacks.onMixClick && ((r = t.config.callbacks.onMixClick.call(t.lastClicked, t.state, u, e)), r === !1)) ||
                (l.matches('[data-filter]') ? ((E = l.getAttribute('data-filter')), (e.activeToggles = []), (e.activeSelectors = e.activeFilters = [E])) : l.matches('[data-toggle]') && ((E = l.getAttribute('data-toggle')), (e.activeFilters = []), (n = e.activeToggles.indexOf(E)) > -1 ? e.activeToggles.splice(n, 1) : e.activeToggles.push(E), 'and' === e.logic ? (e.activeSelectors = [e.activeToggles]) : (e.activeSelectors = e.activeToggles)),
                e.updateControls(),
