  ...
  !(function () {
    ...
    (n = {
      ...
      getCustomEvent: function (e, n, a) {
        var i = null
        return (a = a || t.document), 'function' == typeof t.CustomEvent ? (i = new t.CustomEvent(e, { detail: n, bubbles: !0, cancelable: !0 })) : 'function' == typeof a.createEvent ? ((i = a.createEvent('CustomEvent')), i.initCustomEvent(e, !0, !0, n)) : ((i = a.createEventObject()), (i.type = e), (i.returnValue = !1), (i.cancelBubble = !1), (i.detail = n)), i
      },
      ...
      getDocumentState: function (e) {
        return (e = 'object' == typeof e.body ? e : t.document), { scrollTop: t.pageYOffset, scrollLeft: t.pageXOffset, docHeight: e.documentElement.scrollHeight, docWidth: e.documentElement.scrollWidth, viewportHeight: e.documentElement.clientHeight, viewportWidth: e.documentElement.clientWidth }
      },
      bind: function (t, e) {
        return function () {
    ...
    n.extend(e.Control.prototype, {
      ...
      handleClick: function (t) {
        ...
        for (u = a.callFilters('commandsHandleClick', u, arguments), a.pending = a.bound.length, f = 0; (o = a.bound[f]); f++)
          (l = u[f]), l && (o.lastClicked || (o.lastClicked = i), e.events.fire('mixClick', o.dom.container, { state: o.state, instance: o, originalEvent: t, control: o.lastClicked }, o.dom.document), ('function' == typeof o.config.callbacks.onMixClick && ((s = o.config.callbacks.onMixClick.call(o.lastClicked, o.state, t, o)), s === !1)) || ('toggle' === a.type ? (r ? o.toggleOff(l.filter) : o.toggleOn(l.filter)) : o.multimix(l)))
      ...
      sortOperation: function (t) {
        ...
        e.callActions('beforeSortOperation', arguments),
          ...
          t.newSort.collection
            ...
            : '' === t.newSort.attribute
            ? ((t.newOrder = e.origOrder.slice()), 'desc' === t.newSort.order && t.newOrder.reverse())
