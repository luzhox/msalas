      ...
      a.Mixer.registerAction('afterSanitizeConfig', 'pagination', function () {
        ...
        t.config.pagination.limit < 0 ||
          ...
          (t.config.callbacks.onMixStart = function (e, s) {
            ;(e.activePagination.limit === s.activePagination.limit && e.activePagination.page === s.activePagination.page) || (o = !0), 'function' == typeof i && i.apply(t.dom.container, arguments), o && (a.events.fire('paginateStart', t.dom.container, { state: e, futureState: s, instance: t }, t.dom.document), 'function' == typeof n && n.apply(t.dom.container, arguments))
          }),
          (t.config.callbacks.onMixEnd = function (i) {
            'function' == typeof e && e.apply(t.dom.container, arguments), o && ((o = !1), a.events.fire('paginateEnd', t.dom.container, { state: i, instance: t }, t.dom.document), 'function' == typeof s && s.apply(t.dom.container, arguments))
          }))
      }),
      ...
      a.Mixer.registerFilter('operationUnmappedGetOperation', 'pagination', function (t, e) {
        ...
        return n.config.pagination.limit < 0
          ...
          : ((t.startState = n.state),
            ...
            e.paginate ? n.parsePaginateCommand(e.paginate, t) : (e.filter || e.sort) && (i.extend(t.newPagination, t.startPagination), n.config.pagination.maintainActivePage ? (t.newPagination.page = n.state.activePagination.page) : (t.newPagination.page = 1)),
            t)
      }),
      ...
      a.Mixer.extend({
        ...
        renderPageStatsEl: function (t, e) {
          ...
          return e.newPagination.limit < 0 || e.newPagination.limit === 1 / 0 || (e.newTotalPages < 2 && n.config.pagination.hidePageStatsIfSinglePage)
            ...
            : ((o = 'function' == typeof (o = n.config.render.pageStats) ? o : null),
              ...
              (r = s.totalTargets ? (1 === e.newPagination.limit ? n.config.templates.pageStatsSingle : n.config.templates.pageStats) : n.config.templates.pageStatsFail),
              s.totalTargets && e.newPagination.limit > 0 ? ((s.startPageAt = (e.newPagination.page - 1) * e.newPagination.limit + 1), (s.endPageAt = Math.min(s.startPageAt + e.newPagination.limit - 1, s.totalTargets))) : (s.startPageAt = s.endPageAt = 0),
        ...
        parsePaginateArgs: function (t) {
          ...
          for (n.animate = e.config.animation.enable, n.command = new a.CommandPaginate(), o = 0; o < t.length; o++)
            (s = t[o]), null !== s && ('object' == typeof s && i.isElement(s, e.dom.document) ? (n.command.anchor = s) : s instanceof a.CommandPaginate || 'object' == typeof s ? i.extend(n.command, s) : 'number' == typeof s ? (n.command.page = s) : 'string' != typeof s || isNaN(parseInt(s)) ? ('string' == typeof s ? (n.command.action = s) : 'boolean' == typeof s ? (n.animate = s) : 'function' == typeof s && (n.callback = s)) : (n.command.page = parseInt(s)))
          return i.freeze(n), n
        },
        paginate: function () {
          var a = this,
